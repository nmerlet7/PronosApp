...
import { Competition, Bettor, RankingEntry } from "@/types";
...
export default function CompetitionRanking() {
  ...
  if (!competition) {
    return (
      <View style={styles.container}>
        <Text style={styles.h3}>Compétition non trouvée</Text>
        <TouchableOpacity 
  ...
  // Calculer le classement pour cette compétition
  const calculateRanking = (): RankingEntry[] => {
    ...
    // Calculer les points pour chaque pari selon le système de l'énoncé
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.h2}>{competition.name}</Text>
